...
<body class="skin-josh" style="min-height: 300px;!important;">
<header class="header">
    <a href="{{url('dashboard')}}" class="logo" style="padding-left:0px;">
         <h3>My Medi Medical</h3>
...
<div class="wrapper row-offcanvas row-offcanvas-left" style="min-height: 450px;!important;">
    ...
    <aside class="right-side" style="min-height: 500px;!important;">
